    ...
    <div className="min-h-screen app-shell flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="app-section-card relative p-7 sm:p-8">
          ...
          <p className="app-text-muted mb-6 mt-1">Start with BRaD in less than a minute.</p>

          {error && <div className="mb-4 rounded-lg bg-red-50 p-3 text-sm text-red-700">{error}</div>}

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label htmlFor="name" className="mb-2 block text-sm font-semibold text-[#22301B]">
                Full name
              </label>
              <Input
                id="name"
            ...
            <div>
              <label htmlFor="password" className="mb-2 block text-sm font-semibold text-[#22301B]">
                Password
              </label>
              <Input
                id="password"
            ...
            <div>
              <label htmlFor="role" className="mb-2 block text-sm font-semibold text-[#22301B]">
                Account type
              </label>
              <select
                id="role"
                {...register('role')}
                className="flex h-11 w-full rounded-xl border border-[#9FB08A]/35 bg-white px-3 py-2 text-sm text-[#2B3B23] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              >
