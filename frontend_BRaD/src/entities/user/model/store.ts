...
const normalizeProfilePayload = (payload: unknown): Record<string, unknown> | null => {
  ...
  return {
    ...
    universityId: candidateProfile.universityId,
    isNonStudent: candidateProfile.isNonStudent,
    university: isRecord(candidateProfile.university) ? candidateProfile.university : null,
    ...
    try {
      ...
      if (isCandidateRole(currentUser.role)) {
        const candidatePayload: Record<string, unknown> = {
          ...
          universityId: (data as Record<string, unknown>).universityId,
          isNonStudent: (data as Record<string, unknown>).isNonStudent,
